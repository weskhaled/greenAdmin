...
const getNotifs = async() => {
  const { data, error } = await apiServices('/notification-posts/editor').json()
...
const filterDate = async() => {
  ...
  const { data: datePeriod, error } = await apiServices('/notification-posts/editor-period').post(params).json()
...
meta:
  layout: admin
  siderMenu:
    name: dashboard.notifications.editors
    link: dashboard-notifications-editors
